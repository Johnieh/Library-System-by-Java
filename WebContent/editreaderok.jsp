...
<body>
  ...
  UPDATE reader SET Rname = '<%=request.getParameter("Rname") %>' WHERE Rid = <%=request.getParameter("Rid") %>
	</sql:update>

	<sql:update dataSource="${snapshot}" var="result">
  UPDATE reader SET Rphone = '<%=request.getParameter("Rphone") %>' WHERE Rid = <%=request.getParameter("Rid") %>
	</sql:update>

	<sql:update dataSource="${snapshot}" var="result">
  UPDATE reader SET Remail = '<%=request.getParameter("Remail") %>' WHERE Rid = <%=request.getParameter("Rid") %>
	</sql:update>

	<sql:update dataSource="${snapshot}" var="result">
  UPDATE reader SET Raccount = <%=request.getParameter("Raccount") %> WHERE Rid = <%=request.getParameter("Rid") %>
	</sql:update>
	...
	<hr>
	<h3 align="center">Your have update a reader.</h3>
	<h3 align="center">
		the Reader id is
  ...
  {
	  out.println("the reader id : "+ request.getParameter("Rid") +" is not exist");
  }
%>
