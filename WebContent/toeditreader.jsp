...
-->
	...
	<h3 align="center">edit reader</h3>
	<div align="center">
		<form action="editreader.jsp" method="GET" onsubmit="return check(this);">
			<hr>
			<table width="700" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="50"><strong>ID of Reader:</strong></td>
					<td width="431"><input type="text" name="Rid" id="EBID"
			...
			<br>
			<p>
				<input type="submit" name="FindBookById" value="edit-reader"
