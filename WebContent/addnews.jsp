...
<%@ page import="com.library.manageBook.*" %>
...
<body>
	...
	%>
		<sql:update dataSource="${snapshot}" var="result">
         INSERT INTO news (nid,ntitle,ncontent,ndate) VALUES (null, '<%=request.getParameter("title") %>','<%=request.getParameter("content")%>','<%=session.getAttribute("time")%>');
        </sql:update>
