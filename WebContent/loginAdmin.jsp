...
<body>
	...
	<form action="adminLoginCheck.jsp" method="post" onsubmit="return check(this);">
		<h1>Admin Login</h1>
		<hr />
		<table align="center">
			...
			<tr>
				<td>ID：</td>
				<td><input type="text" name="adminId" class="form-control" id="adminID"
					></td>
			</tr>
			<tr>
				<td>Password：</td>
				<td><input type="password" name="adminPassword" class="form-control" id="adminPassword"
					></td>
			</tr>
			<tr>
				<td colspan="1"></td>
